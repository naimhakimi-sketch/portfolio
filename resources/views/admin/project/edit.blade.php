...
<div class="content">
    <form method="POST" action="{{ route('admin.project.update', $project) }}" enctype="multipart/form-data">
        ...
        <div class="form-group @error('short_description') error @enderror">
            ...
            <textarea id="short_description" name="short_description" style="min-height: 80px;" required>{{ old('short_description', $project->short_description) }}</textarea>
        ...
        <div class="form-group @error('full_description') error @enderror">
            ...
            <textarea id="full_description" name="full_description" required>{{ old('full_description', $project->full_description) }}</textarea>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
            <div class="form-group @error('project_type') error @enderror">
                ...
                <input type="text" id="project_type" name="project_type" value="{{ old('project_type', $project->project_type) }}" placeholder="e.g., Web App, Mobile App" required>
        ...
        <div class="form-group @error('image') error @enderror">
            ...
            @if($project->image)
                <p style="margin-top: 0.5rem; color: #666;">
                    Current: <img src="{{ Storage::url($project->image) }}" alt="Image" style="max-width: 200px; max-height: 150px;">
                </p>
            @endif
        ...
        <div class="form-group">
            ...
            <div id="tech-stack-container">
                ...
                <div class="tech-input" style="display: flex; gap: 0.5rem; margin-bottom: 0.5rem;">
                    <input type="text" name="tech_stack[]" value="{{ $tech }}" style="flex: 1; padding: 0.75rem; border: 1px solid #bdc3c7; border-radius: 5px;">
